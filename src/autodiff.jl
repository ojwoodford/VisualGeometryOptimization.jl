using ForwardDiff #, Interpolations, StaticArrays
...
# # Image sampling
# function sample(iminterpolator::AbstractInterpolation, pixcoords::SVector{2, T}) where T <: ForwardDiff.Dual
#     val = iminterpolator(value(pixcoords[1]), value(pixcoords[2]))
#     grad = gradient(iminterpolator, value(pixcoords[1]), value(pixcoords[2]))
#     return 
# end